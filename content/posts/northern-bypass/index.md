...
<img alt="Six blue ship-to-shore cranes lowered above a container ship behind them, and another crane raised to their left. In front (closer to the camera) are a few small stacks of containers and a fence with black posts. In the foreground is long grass bisected by a stream about three metres wide, and a tree in the left of the frame. The sky is blue with one cloud." async src="images/port.jpg" width="1920px"></img>
...
<img alt="A rural track going down a hill with a grass verge on both sides, and fields of dirt beyond each verge. On the right verge is a leafless tree, with a leafless bush at its base. The sky is perfect blue and the sun is to the right of the frame but not visible." async src="images/inner-route.jpg" width="1920px" loading="lazy"></img>
...
<img alt="Train schedule entry. 7:07 to 7:17, Ipswich to Stowmarket. Platform 3 estimated. Cost £7.20. First class cost £10.30. 0 changes." async src="images/ips-smk-fare.png" width="390px" loading="lazy"></img> <img alt="Train schedule entry. 7:07 to 7:47, Ipswich to Norwich. Platform 3 estimated. Cost £7. First class cost £32.30. 0 changes." async src="images/ips-nrw-fare.png" width="389px" loading="lazy"></img>
...
<img alt="A grey river bounded by a man-made embankment of square stones, and a grassy verge above. On the left is a long row of new houses built with lightly-coloured bricks, with the top floor set back and clad in black. To the right, a long row of older houses built with darker bricks. In the distance, some high-rise buildings." async src="images/merchants-yard.jpg" width="1920px" loading="lazy"></img>
...
<img alt="A dull sky atop grey water peppered with raindrops. To the left, there are lots of boats and small yachts moored on the other side of the marina. Centre and right, high-rise residential buildings. In the foreground, disused floating walkways formerly used by the marina." async src="images/waterfront.jpg" width="1920px" loading="lazy"></img>
...
<img alt="In the foreground, a pedestrian area with a concrete bar to sit on. Behind it, a junction with one one-lane, two three-lane and one four-lane road, controlled by traffic lights. In the distance is the Portman Road football stadium." async src="images/train-station.jpg" width="1920px" loading="lazy"></img>
